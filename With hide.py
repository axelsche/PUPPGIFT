...
def main():
    global root, btn_show_table, btn_test_proton, btn_test_abbreviation, btn_test_masses, btn_submit_answer, btn_hide_table, text_widget, entry_widget, attempts_label, original_periodic_table, table_frame
